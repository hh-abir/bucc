export const json = {
  ...
  pages: [
      ...
      elements: [
        {
          ...
          description: "E.g. personality, positive and negative sides, achievements, etc.\n\n",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
        {
          ...
          name: "question5",
          title: "Why BUCC?",
          description: "Why you want to join BUCC. You can select multiple options.",
          isRequired: true,
          requiredErrorText: "This field is required",
          choices: [
            "Want to learn",
    ...
    },
    {
      ...
      description: "Choose any of the departments from below and read their respective section before continuing to the next one. Read the description provided for each department carefully before choosing your 2nd preferred department.",
    },
    {
      ...
      elements: [
        {
          type: "comment",
          name: "question10",
          title: "Write a captivating short caption for the BUCC Fresher's Orientation program.",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
        {
          type: "comment",
          name: "question11",
          title: "How do you get in touch with other businesses on behalf of a club?",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
      ],
      visibleIf: "{question8} = 'Communication and Marketing' or {question32} = 'Communication and Marketing'",
      title: "Communication and Marketing",
      description: "This department manages the marketing and advertising efforts of BUCC. Their key responsibilities include promoting upcoming events, workshops, or seminars through online channels or posters. They play a vital role in spreading awareness and attracting participants to BUCC's activities.",
    },
    {
      name: "Creative",
      elements: [
        ...
        },
        {
          type: "text",
          name: "question13",
          title: "Have you done any artwork, design, or edited videos before? If yes, can you show us some of your work?",
          description: "Provide a drive link of your content, and don't forget to turn the share option on.",
          isRequired: true,
          requiredErrorText: "This field is required",
          inputType: "url",
        },
        ...
        },
        {
          type: "comment",
          name: "question15",
          title: "Imagine, the club is planning an event with a unique theme that totally differs from what you had in mind. How would you boldly take on the challenge of modifying your creative ideas and skill level to fit this unexpected topic, all the while ensuring a smooth and eye-catching result?",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
      ],
      visibleIf: "{question8} = 'Creative' or {question32} = 'Creative'",
      title: "Creative",
      description: "This department primarily oversees the creative and design aspects of BUCC. Individuals possessing design skills, graphic work expertise, or unique creative ideas have a strong potential to thrive in this department. Crafting posters, banners, backdrops, brochures, producing videos and motion graphics, and decor events are the focal responsibilities of this department.",
    },
    {
      ...
      elements: [
        ...
        },
        {
          type: "text",
          name: "question17",
          title: "If you have an interest in photography, can you show us some of your works?",
          description: "Provide a drive link of your photos, and don't forget to turn the share option on.",
          isRequired: true,
          requiredErrorText: "This field is required",
          inputType: "url",
        },
        ...
        },
        {
          type: "comment",
          name: "question19",
          title: "What makes an event successful and how do you measure that success?",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
        {
          type: "comment",
          name: "question20",
          title: "In the club, you will get to know students from various semesters. You are assigned to manage an event with other fellow club members. How would you manage to cope with juniors and seniors?",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
        {
          type: "rating",
          name: "question21",
          title: "How do you rate your negotiation skills with third parties such as stationery shops, Hardware shops, Restaurants, etc?",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
      ],
      visibleIf: "{question8} = 'Event Management' or {question32} = 'Event Management'",
      title: "Event Management",
      description: "This department is responsible for organizing events, handling various tasks such as booking venues like the auditorium and GDLN rooms, arranging food distribution, obtaining guest entry permissions from the Registrar, and managing necessary equipment for events. Additionally, they oversee photography management and storage. Living near the university is preferred for those interested in joining this department.",
    },
    {
      name: "Finance",
      elements: [
        {
          type: "boolean",
          name: "question22",
          title: "Have you ever worked related to finance or made a budget before?",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
        {
      ...
      visibleIf: "{question8} = 'Finance' or {question32} = 'Finance'",
      title: "Finance",
    ...
    },
    {
      ...
      elements: [
        {
          type: "checkbox",
          name: "question24",
          title: "Sabrina is a member of the X department. She has to write an email to all the members of the whole club. But she is struggling to write an email that is appropriate for this whole crowd. So what would be the most logical solution to this problem?",
          isRequired: true,
          requiredErrorText: "This field is required",
          choices: [
      ...
      visibleIf: "{question8} = 'Human Resources' or {question32} = 'Human Resources'",
      title: "Human Resources",
      description: "This department at BUCC is tasked with managing and maintaining member data, allocating volunteers, and ensuring their presence at every event. They handle registration and maintain etiquette among executive bodies, ensuring smooth operation of club activities. Additionally, they notify members about club events or other relevant information through email. If you're organized, communicative, and enjoy working with people, you might have what it takes to excel in HR.",
    },
    {
      ...
      elements: [
        {
          type: "text",
          name: "question26",
          title: "If you have written any articles, short stories, or novels before, can you show us some of your works?",
          description: "Provide a drive link, or website links (if published) of your writings, and don't forget to turn the share option on.",
          isRequired: true,
          requiredErrorText: "This field is required",
          inputType: "url",
        },
        {
          type: "radiogroup",
          name: "question27",
          title: "What qualities do you think a published news portal article should have among these?",
          isRequired: true,
          requiredErrorText: "This field is required",
          choices: [
            "Concise",
        ...
        },
        {
          type: "comment",
          name: "question28",
          title: "What do you think about ChatGPT? Is it good to use ChatGPT in institutional/organizational writings?",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
      ],
      visibleIf: "{question8} = 'Press Release and Publications' or {question32} = 'Press Release and Publications'",
      title: "Press Release and Publications",
      description: "This department takes charge of creating post-event press releases, promotional posts, and publications for all BUCC events. Individuals with writing skills and a penchant for research are encouraged to join this department. They play a crucial role in documenting and publicizing the outcomes of BUCC's events to a wider audience.",
    },
    {
      ...
      elements: [
        {
          type: "checkbox",
          name: "question29",
          title: "Are you developing any skills right now? If yes specify what kind of skills you are developing.",
          isRequired: true,
          requiredErrorText: "This field is required",
          choices: [
        ...
        },
        {
          type: "comment",
          name: "question30",
          title: "Do you have any projects regarding your selected skills? If yes give us a description about your project. If it's regarding problem solving describe that as well.",
          isRequired: true,
          requiredErrorText: "This field is required",
        },
        {
          ...
          description: "Provide a github, drive link, or live link (if deployed) of your project, and don't forget to turn the share option on if providing a drive link. If it's any online portfolio (Leetcode, Codeforces, Portfolio Website, etc) you can attach that as well.",
          isRequired: true,
          requiredErrorText: "This field is required",
          inputType: "url",
        },
      ],
      visibleIf: "{question8} = 'Research and Development' or {question32} = 'Research and Development'",
      title: "Research and Development",
      description: "The Research and Development department at BUCC focuses on exploring innovative ideas and enhancing the organization's offerings. This team is dedicated to conducting research to improve existing projects and develop new initiatives. Individuals with a passion for exploring new concepts and problem-solving are encouraged to join this department. They play a key role in innovation through their dedication to continuous improvement and forward-thinking strategies.",
    },
    {
      name: "Brain Teaser",
      elements: [
        {
          type: "text",
          name: "question33",
          title: "Rearrange/Anagram this line in such a way that it produces the same output: ELEVEN PLUS ONE",
        },
        {
          type: "image",
          name: "Brain Teaser Question 2 Image",
          imageLink: "https://api.surveyjs.io/private/Surveys/files?name=f0856d25-ff3d-4ffa-aa40-ba3bda9982d0",
          imageFit: "cover",
          imageHeight: "auto",
          imageWidth: "100%",
        },
        {
          ...
          description: "Just to check how sincere you are with your studies. This should be a piece of cake if you are done with the lectures of week 3 of the CSE110 course. \nP:S Don't use any IDE to solve this, try to solve it without anyone's help",
          choices: [
        ...
        },
        {
          type: "expression",
          name: "question38",
          title: "Alan Turing was trying to crack enigma. He saw that it encrypts “HEIL HITLER” into “MJNQ MNYQFW”. Now decode the messages given below if you can.",
          description: "Look at the image in the bottom if you need any help. But I will encourage you not to look. Please try to crack it by yourself first.",
        },
        {
          type: "image",
          name: "Brain Teaser Question 6 7 Image",
          imageLink: "https://api.surveyjs.io/private/Surveys/files?name=1f0855ca-cc35-48f2-90f4-7a16ad2a559f",
          imageFit: "cover",
          imageHeight: "auto",
          imageWidth: "100%",
        },
      ...
      title: "Brain Teaser",
      description: "Congratulations! You have come a long way. Now, go have a glass of water and stretch yourself because now it is time to stress your brain. This is the last step so give it your all!",
    },
  ],
};
