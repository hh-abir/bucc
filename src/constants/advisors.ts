...
const coAdvisorsData = [
  {
    name: "Arif Shakil",
    designation: "Co-Advisor",
    bracu_designation: "Lecturer",
    image: coAdvisor1Image,
    bio: "Arif Shakil has been an integral part of BRAC University since his undergraduate days. Currently a Lecturer in the CSE Department, he started his journey as a Student Tutor and Mentor, supporting his peers in their academic pursuits. He earned his B.Sc. in CSE from BRAC University in 2017 and is currently pursuing his Master's degree. His early education includes completing O' Levels at BAF Shaheen English Medium School and A' Levels through the British Council under the Edexcel Board. His dedication to BUCC as a Co-Advisor reflects his passion for fostering student growth and learning.",
    linkedin: "https://www.linkedin.com/in/arifshakil",
...
export { advisorsData, coAdvisorsData };
